...
import { AwsSpec, AwsSpecProps } from "@envtio/base/lib/aws";
import {
  S3Backend,
  S3BackendConfig,
...
export interface FoggStackProps extends Omit<AwsSpecProps, "providerConfig"> {
  /**
 ...
 */
export class FoggStack extends AwsSpec {
...
function parseAwsProviderConfig(
  ...
  if (
    ...
    throw new Error(
      "AWS regional providers are not supported by envtio components",
    );
  }
  if (providers.aws) {
