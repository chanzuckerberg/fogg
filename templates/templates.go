...
//go:embed templates/component/cdktf/.vscode/launch.json.tmpl
//go:embed templates/component/cdktf/.eslintrc.json.rm
//go:embed templates/component/cdktf/.prettierrc.json.tmpl
//go:embed templates/component/cdktf/.gitignore.create
//go:embed templates/component/cdktf/.gitattributes.tmpl
//go:embed templates/component/cdktf/.prettierignore.create
//go:embed templates/component/terraconstructs/.vscode/launch.json.tmpl
//go:embed templates/component/terraconstructs/.eslintrc.json.rm
...
//go:embed templates/component/terraconstructs/.gitattributes.tmpl
//go:embed templates/component/terraconstructs/.prettierignore.create
//go:embed templates/component/*
//go:embed templates/env/*
//go:embed templates/module/cdktf/.vscode/launch.json.tmpl
//go:embed templates/module/cdktf/.eslintrc.json.rm
//go:embed templates/module/cdktf/.prettierrc.json.tmpl
//go:embed templates/module/cdktf/.gitignore.create
//go:embed templates/module/cdktf/.gitattributes.tmpl
